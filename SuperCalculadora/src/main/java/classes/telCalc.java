 ...
 * @author marksaurelio
 */
public class telCalc extends javax.swing.JFrame {

    /**
     * Creates new form telCalc
     */
    public telCalc() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnCalc.setFont(new java.awt.Font("Helvetica Neue", 0, 14)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telCalc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
